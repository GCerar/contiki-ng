/* -----------------------------------------------------------------------------
 * STATS-APP MULTICAST version 1
 *
 * Root sends icmp6 echo request to all neighbour == "multicast messages"
 * 
 * 22.6.2020 - App works, but because Vesna drivers or Contiki, app crashes 
 * 			   randomly every now and then (Hardfault_Handler)
 * -----------------------------------------------------------------------------
*/
